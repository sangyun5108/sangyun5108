...
function onClickButton() {
  var buttons = document.querySelectorAll('.project__buttons');
...
function filterProject(type) {
  var projects = document.querySelectorAll('.project__container');
...
function onClickIcon() {
  var goUpIcon = document.querySelector('.goback__first');
