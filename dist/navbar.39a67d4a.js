...
'use strict'; //scroll eventListener 함수 등록
...
function onClickNavbarItems() {
  var navbarMenus = document.querySelector('.navbar__menu');
  navbarMenus.addEventListener('click', function (e) {
    goCorrectPage(e);
  });
...
function goCorrectPage(e) {
  ...
  var type = 'start';
  var width = document.body.getBoundingClientRect().width; //화면 너비에 따라 다른 scrollintoView 조건 부여
...
function onClickToggleMenu() {
  var toggleMenu = document.querySelector('.navbar__toggle-btn');
